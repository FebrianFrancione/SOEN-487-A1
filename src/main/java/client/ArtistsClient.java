...
public class ArtistsClient {
    ...
    public void getArtist(String nickname){
        try(CloseableHttpClient client = HttpClients.createDefault()){
            HttpGet request = new HttpGet("http://localhost:8980/SOEN_REDO_war_exploded/artists?nickname=" + nickname);
            ResponseHandler<String> responseHandler = readResponse();
            String result = client.execute(request, responseHandler);
            System.out.println();
            System.out.println(result);
    ...
    public void sendArtist(String nickname, String first_name, String last_name, String biography){
        try(CloseableHttpClient client = HttpClients.createDefault()){
            HttpPost request = new HttpPost("http://localhost:8980/SOEN_REDO_war_exploded/artists?nickname=" + nickname + "&first_name=" + first_name + "&last_name=" + last_name + "&biography=" + biography);
            ResponseHandler<String> responseHandler = readResponse();
            String result = client.execute(request, responseHandler);
            System.out.println();
            System.out.println(result);
    ...
    public void updateArtist(String nickname, String first_name, String last_name, String biography){
        try(CloseableHttpClient client = HttpClients.createDefault()){
            HttpPut request = new HttpPut("http://localhost:8980/SOEN_REDO_war_exploded/artists");
    ...
    public void deleteArtist(String nickname){
        try(CloseableHttpClient client = HttpClients.createDefault()){
            HttpDelete request = new HttpDelete("http://localhost:8980/SOEN_REDO_war_exploded/artists?nickname=" + nickname);
            ResponseHandler<String> responseHandler = readResponse();
            String result = client.execute(request, responseHandler);
            System.out.println();
            System.out.println(result);
